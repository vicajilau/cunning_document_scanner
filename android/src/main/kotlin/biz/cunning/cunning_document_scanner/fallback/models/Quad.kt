...
class Quad(
    ...
    fun getCornerClosestToPoint(point: PointF): QuadCorner = corners.minByOrNull { corner -> corner.value.distance(point) }?.key!!
    ...
    fun mapOriginalToPreviewImageCoordinates(
    ...
    // / - ratio: Image-to-preview scale multiplier factor.
    fun mapPreviewToOriginalImageCoordinates(
        imagePreviewBounds: RectF,
        ratio: Float,
    ): Quad =
        Quad(
